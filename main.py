...
def reduce_colors(image_path, num_colors):
    ...
    quantized_pixels = centers[labels].reshape(img_rgb.size + (3,))
...
def color_save(image, labels, centers, output_folder):
    ...
    for label in unique_labels:
        ...
        output_path = os.path.join(output_folder, f'color_{hex_color}.jpg')
...
if __name__ == "__main__":
    ...
    color_save(reduced_image, color_labels, color_centers, output_folder)
    print('ok')
